    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-32 font-sans relative">
            ...
            <div className="relative h-56 md:h-72 w-full bg-gray-200">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${venue.cover_image || '/placeholder.svg'})` }} />
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col justify-between py-0.5">
                                    ...
                                    <div className="flex justify-between items-end mt-2">
                                        ...
                                        <Button size="sm" variant="ghost" className="h-7 w-7 p-0 rounded-full bg-gray-50 text-primary">+</Button>
                                    </div>
                                </div>
                            </div>
                        ))
